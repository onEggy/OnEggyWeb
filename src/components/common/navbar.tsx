...
const megaMenuServices = [
  {
    ...
    items: [
      ...
      { name: "Cost Optimization", desc: "Audit cloud bills & reduce waste", href: "/services/cloud-cost-optimization", icon: <Layers className="h-4 w-4 text-primary/80" /> },
      { name: "Cloud Migration", desc: "Multi-cloud architecture & migration", href: "/services/cloud-migration", icon: <Laptop className="h-4 w-4 text-primary/60" /> }
    ]
  },
  {
    category: "DevOps & IaC",
    items: [
      ...
      { name: "CI/CD & Delivery", desc: "Automate build & release pipelines", href: "/services/cicd-pipeline-automation", icon: <Settings className="h-4 w-4 text-primary/80" /> },
      { name: "Platform Engineering", desc: "Developer self-service templates", href: "/services/platform-engineering", icon: <Code className="h-4 w-4 text-primary/60" /> }
    ]
  },
  {
    ...
    items: [
      ...
      { name: "React Native Mobile Apps", desc: "Cross-platform iOS & Android apps", href: "/services/mobile-app-development", icon: <Laptop className="h-4 w-4 text-primary/80" /> },
      { name: "Security & DevSecOps", desc: "Rigorous pentesting & compliance checks", href: "/services/security-devsecops", icon: <ShieldAlert className="h-4 w-4 text-primary/60" /> }
    ]
  }
];
      ...
      <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-8">
          ...
          <div className="flex items-center gap-4">
            ...
            >
              <span className="absolute inset-0 bg-primary opacity-0 group-hover:opacity-100 transition-opacity duration-300 -z-10" />
              <span className="relative z-10 group-hover:text-zinc-950 transition-colors">Book Free Consultation</span>
            </Link>
          </div>
        </nav>
