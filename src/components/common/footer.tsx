...
export function Footer() {
  ...
  return (
    <footer className="relative border-t border-border/40 bg-background/50 backdrop-blur-md overflow-hidden">
      ...
      <div className="absolute top-[-200px] left-[10%] w-[500px] h-[500px] rounded-full bg-primary/5 blur-[130px] pointer-events-none animate-pulse -z-10" style={{ animationDuration: "8s" }} />
      <div className="absolute bottom-[-100px] right-[5%] w-[400px] h-[400px] rounded-full bg-indigo-500/5 blur-[100px] pointer-events-none animate-pulse -z-10" style={{ animationDuration: "12s" }} />
      ...
      <div className="max-w-7xl mx-auto px-6 py-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 relative z-10">
        ...
        <div className="lg:col-span-2 space-y-6">
          <Link href="/" className="inline-block group relative">
            ...
            <div className="absolute inset-0 bg-primary/5 rounded-lg blur-md opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none" />
          ...
          <div className="flex items-center gap-3">
            <a
              ...
              className="w-8 h-8 rounded-md border border-border/60 flex items-center justify-center text-muted-foreground hover:text-primary hover:border-primary/45 bg-background/40 hover:bg-background transition-all"
            >
          ...
          <div>
            ...
            <ul className="space-y-3.5">
              ...
              <li className="flex items-center gap-2 text-sm text-muted-foreground">
                ...
                <a href="mailto:ask@oneggy.com" className="hover:text-primary transition-colors">
                  ask@oneggy.com
                </a>
              </li>
              <li className="flex items-center gap-2 text-sm text-muted-foreground">
                <Phone className="h-4 w-4 text-primary shrink-0" />
                <a href="tel:+919811133005" className="hover:text-primary transition-colors">
                  +91 98111 33005
                </a>
              </li>
            </ul>
          ...
          <div className="space-y-2 border-t border-border/40 pt-4">
            ...
            <form onSubmit={handleSubscribe} className="relative mt-2">
              ...
              <input
                ...
                className="w-full h-9 pl-3 pr-9 rounded-md bg-background border border-border/60 text-xs focus:ring-1 focus:ring-primary focus:outline-none placeholder:text-muted-foreground/60 disabled:opacity-50"
              />
              <button
                type="submit"
                disabled={status === "loading" || status === "success"}
