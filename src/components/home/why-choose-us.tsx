...
export function WhyChooseUs() {
  ...
  return (
    <section className="max-w-7xl mx-auto px-6 py-24 border-t border-border/40 relative">
      {/* Background Glow */}
      <div className="absolute top-[10%] right-[10%] w-[350px] h-[350px] rounded-full bg-primary/2 blur-[90px] pointer-events-none -z-10 animate-pulse" />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
        ...
        <div className="lg:col-span-5 space-y-6">
          ...
          <FadeUp delay={0.2} className="space-y-4 pt-6 border-t border-border/30">
            <div className="flex gap-4">
              ...
              <div className="space-y-1">
                <h4 className="text-sm font-bold text-foreground font-display">Senior Architect Led</h4>
            ...
            <div className="flex gap-4">
              ...
              <div className="space-y-1">
                <h4 className="text-sm font-bold text-foreground font-display">Spend Optimization</h4>
                <p className="text-xs text-muted-foreground leading-relaxed">
            ...
            <div className="flex gap-4">
              ...
              <div className="space-y-1">
                <h4 className="text-sm font-bold text-foreground font-display">Zero Vendor Lock-in</h4>
                <p className="text-xs text-muted-foreground leading-relaxed">
        ...
        <div className="lg:col-span-7">
          <FadeIn delay={0.3} className="w-full">
            <div className="border border-border rounded-2xl overflow-hidden bg-card/25 shadow-xl backdrop-blur-md">
              <div className="p-6 border-b border-border/80 bg-secondary/15">
                ...
                {comparisonRows.map((row) => (
                  <div key={row.dimension} className="p-6 grid grid-cols-1 md:grid-cols-12 gap-4 items-start">
                    ...
                    <div className="md:col-span-4 flex items-start gap-2">
                      <XCircle className="h-4 w-4 text-destructive/80 shrink-0 mt-0.5" />
