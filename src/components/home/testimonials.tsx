              ...
              return (
                ...
                >
                  ...
                  <div className="flex items-center gap-3 border-t border-border/20 pt-4 mt-5">
                    <div className={`w-9 h-9 rounded-full ${avatarStyle} flex items-center justify-center text-foreground font-bold font-mono text-xs shadow-md shrink-0 select-none`}>
      ...
      {list.length > 9 && (
        <div className="flex justify-center mt-12 relative z-20">
          <button
            ...
            className="inline-flex items-center gap-2 px-6 py-3 rounded-lg border border-border/80 bg-background/60 hover:bg-secondary/40 text-xs sm:text-sm font-semibold transition-all cursor-pointer shadow-md text-foreground"
          >
            {showAll ? (
              <>
