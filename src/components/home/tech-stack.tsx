  ...
  return (
    <section className="max-w-7xl mx-auto px-6 py-24 border-t border-border/40 relative animate-fade-in" id="technology-ecosystem">
      ...
      <div className="absolute top-2 left-6 font-mono text-[8px] text-muted-foreground/30 select-none">
        GRID.SEC.D // STACK.Ecosystem_V1.1
      </div>
        ...
        <AnimatePresence mode="wait">
          ...
          >
            {activeCategory?.items.map((item) => (
              ...
              >
                <div className="w-10 h-10 rounded-lg bg-background border border-border flex items-center justify-center shrink-0 shadow-sm relative overflow-hidden group-hover:border-primary/30 transition-colors">
