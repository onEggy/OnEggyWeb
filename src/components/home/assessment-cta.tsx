...
const auditSteps = [
  ...
  {
    num: "3",
    icon: <ClipboardCheck className="h-5 w-5 text-primary/60" />,
  ...
  return (
    <section className="max-w-7xl mx-auto px-6 py-20 border-t border-border/40 relative">
      ...
      <div className="absolute top-2 left-6 font-mono text-[8px] text-muted-foreground/30 select-none">
        GRID.SEC.G // AUDIT.OFFER_V1.1
      </div>

      <div className="glass-card rounded-2xl border border-border p-8 md:p-12 shadow-2xl relative overflow-hidden bg-background/20 backdrop-blur-md">
          ...
          <div className="lg:col-span-5 space-y-6">
            <div className="space-y-3">
              ...
              <h2 className="text-3xl sm:text-4xl font-bold tracking-tight text-foreground leading-tight">
                Get a Free <br />
                <span className="text-primary font-bold">Cloud Cost & Security Audit</span>
              </h2>
            </div>
