...
const ProjectLogosTools = () => {
    ...
    return (
        <main className="sm:mt-14 my-12  md:ml-4">
            <div className="inner">
                <Marquee pauseOnHover={false} speed={30} pauseOnClick={false} gradient={true} gradientColor={"none"} autoFill={true}>
...
export default ProjectLogosTools;
