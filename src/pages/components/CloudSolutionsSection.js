                ...
                <div className="mt-[80px] mb-[77px] grid grid-cols-1 lg:grid-cols-2 gap-8">
                    ...
                    <div className="grid grid-cols-1 gap-6">
                        ...
                        <div className="flex items-start">
                            <div className="text-gray-900 w-10 h-10 flex items-center justify-center rounded-full mr-4">
                        ...
                        <div className="flex items-start">
                            <div className="text-gray-900 w-10 h-10 flex items-center justify-center rounded-full mr-4">
                                <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M26.513 19.8626C25.7178 21.7432 24.474 23.4004 22.8904 24.6892C21.3067 25.9781 19.4315 26.8594 17.4286 27.2561C15.4256 27.6528 13.356 27.5528 11.4007 26.9648C9.44534 26.3769 7.66379 25.3189 6.21178 23.8834C4.75977 22.4479 3.68152 20.6785 3.0713 18.73C2.46107 16.7815 2.33746 14.7132 2.71125 12.7059C3.08505 10.6986 3.94487 8.81338 5.21556 7.21513C6.48625 5.61689 8.12911 4.35424 10.0005 3.5376" stroke="#54BD95" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
