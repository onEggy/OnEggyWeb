...
export default function NavbarDevops({ onScrollToCalConnect, isNavbarVisible }) {
    return (
        <Disclosure
            as="nav"
            className={`transition-transform duration-300 ${isNavbarVisible ? "translate-y-0" : "-translate-y-full"
                } top-0 z-50 bg-[radial-gradient(circle_at_top_left,_#37FFF4_-500%,_#ffffff_70%)]`}
        >
            {({ open }) => (
                <>
