...
export default function GetStarted() {
    ...
    const handleFormSubmit = async (e) => {
        e.preventDefault();
        const subject = "DevOps Page Inquiry";
    ...
    return (
        <div className="bg-l_black font-inter hidden md:block text-white py-16 px-[16px] md:px-[7rem]">
            <div className="mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div>
                    ...
                    <ul className="space-y-4">
                        ...
                        <li className="hover:underline cursor-pointer">VAPT Assessment Services</li>
                        <li className="hover:underline cursor-pointer">UI UX Designing Services</li>
                        <li className="hover:underline cursor-pointer">More Services</li>
                    </ul>
                </div>
                ...
                <div className="bg-gray-800 p-8 rounded-lg shadow-lg">
                    ...
                    <form className="space-y-4" onSubmit={handleFormSubmit}>
                        ...
                        <button
                            type="submit"
                            className="w-full bg-[#37FFF4] text-gray-900 font-semibold py-3 rounded-[10px] hover:bg-teal-600 transition"
                            disabled={isLoading}
                        >
