  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-start sm:items-start sm:flex-1">
        ...
        <div className="flex items-center sm:ml-12 mt-4">
          <svg
            ...
            className={`rounded-full ${arrowBg(index)} ${arrowColor(index)}`}
          >
            <path
      ...
      <div className="flex justify-center sm:justify-end mt-4 sm:mt-0 sm:flex-1">
        <div className="relative w-full max-w-[220px] h-[160px] sm:max-w-[240px] sm:h-[180px] overflow-hidden rounded-[1.5rem]">
          <Image
            src={skill.imageSrc}
