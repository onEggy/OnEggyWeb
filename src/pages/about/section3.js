...
const section3 = (props) => {
  ...
  return (
    <div className="flex sm:flex-row flex-col sm:items-center px-4 sm:px-0 sm:justify-between sm:mt-10 mt-2">
      ...
      <div className="sm:px-4 px-2 sm:w-1/2 textss-center">
        <h2 className=" sm:mb-8 bg-blue inline-block font-semibold my-8 sm:m-0 py-2 rounded-md text-3xl">
          {title}
        </h2>
        <p className="text-left">{props.boxContent}</p>
      </div>
    </div>
  );
};
